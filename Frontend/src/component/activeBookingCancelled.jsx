...
class ActiveBooingCancelled extends Component {
    state = { 
        activeBooking:[],
     }
     
     componentDidMount(){
        activeBoookingService.findByCancelled().then(res=>this.setState({activeBooking:res.data})
        );
    }
    handleDelete=(id)=>{
...
export default ActiveBooingCancelled;