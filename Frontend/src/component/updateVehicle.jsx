...
class UpdateVehicle extends Component {
  ...
  componentDidMount = async () => {
    VehicleService.getVehicleById(this.props.match.params.id).then(
      (response) => {
  ...
  handleSubmit = (event) => {
    ...
    if (errors) return;
    VehicleService.updateVehicle(this.state.vehicle)
      .then((response) => {
  ...
  render() {
    return (
      <div
        className="w-50 mx-auto p-3 mt-5"
        style={{
          borderStyle: "solid",
          borderColor: "#FFBE00",
          borderRadius: "8px",
      ...
      >
        ...
        <div className="p-2">
          <h3 className="p-2">Update Vehicle</h3>
