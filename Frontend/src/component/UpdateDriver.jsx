...
componentDidMount=async ()=>{
    const driver = await DriverService.getDriverById(this.props.match.params.id);
    this.setState({driver:driver.data});
}
  ...
  handleSubmit = (event) => {
    ...
    DriverService.updateDriver(this.state.driver,this.state.driver.driverId)
