...
class ActiveBookingCompleted extends Component {
    state = { 
        activeBooking:[],
     }
     
     componentDidMount(){
        activeBoookingService.findByCompleted().then(res=>this.setState({activeBooking:res.data})
        );
    }
    handleDelete=(id)=>{
...
export default ActiveBookingCompleted;